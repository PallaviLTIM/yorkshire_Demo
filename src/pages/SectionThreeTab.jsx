import {  Box, FormControlLabel, Grid, Radio, RadioGroup, TextField, TableCell, styled, tableCellClasses, Typography, Select,MenuItem,Button, Paper, TableRow, TableContainer, Table, TableBody, TableHead } from '@mui/material';
      ...
      <Table sx={{ minWidth: 700 }} aria-label="customized table" margin={5}>
        <TableHead>
          <TableRow>
            ...
            <StyledTableCell align="right">Type/method of isolation</StyledTableCell>
          </TableRow>
        </TableHead>
        <TableBody>
          {/* {rows.map((row) => ( */}
