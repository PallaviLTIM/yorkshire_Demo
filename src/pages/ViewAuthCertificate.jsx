...
export function ViewAuthCertificate(props){
    ...
    return (
        ...
        <Grid item xs={12} md={3} className="grid-sp">
            ...
            <Grid item xs={12} md={12} className="grid-sp">
                <Typography className="label-cls">
                    Site/emergency procedures: </Typography>
                    <Typography>In accordance with site induction.
                </Typography>  
            </Grid>

            <Grid item xs={12} md={12} className="grid-sp">
                <Typography className="label-cls">
                    Any other instructions/conditions:</Typography>
                    <Typography> when the handover is in force the contractor shall demark the working area and erect appropriate barriers and warning notices. All other personnel visiting the site shall make prior contact with the contractor using the information detailed on the contractors sign at the site entrance to a) ensure that an appropriate level of communication is maintained, and  b) Seek appropriate consent for any interaction with the site low voltage electrical system during the works.

Not intrusive work(affecting normal operations) shall be carried out without prior authorization rom the local YW service delivery team and appropriate work management systems being employed. All request for intrusive works are to be made a minimum of two weeks in advance of the planned works, and supported by RAMS and mitigation plan.
                </Typography>  
            </Grid>

            <Grid item xs={12} md={12} className="grid-sp">
                <Typography className="label-cls">
                    Need for access by YW Personnel/others: </Typography>
                    <Typography>Access by YW personnel to carry out opertaional activities is permitted at all times. Access by YW maintenance personnel (or works by other contractors) when the low voltage electrical system is affected shall only be by prior agreement with the contractor that is in posession of this certificate.
                </Typography>  
            </Grid>
         {/* </Grid> */}
        </Grid>
